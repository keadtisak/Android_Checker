...
public class CheckSubject {
    ...
    public static  boolean chSubject;
    public boolean checkSubject(Mat image ,int num){
        ...
        IdSubject = IdSubject+ans;
        //id.setIDstudent(ans);
        //Log.i("Subject Check ", Arrays.toString(sumRows));
        Log.e("Check Subject:",num+" "+ans );
